...
namespace KutuphaneUI.Sayfalar
{
    ...
    {
        SqlConnection baglanti = new SqlConnection("Data Source=ENES-PC;Initial Catalog=KutuphaneDatabase;Integrated Security=True");
        SqlDataAdapter da;
        ...
        {
            baglanti = new SqlConnection("Data Source=ENES-PC;Initial Catalog=KutuphaneDatabase;Integrated Security=True");
            baglanti.Open();
